...
void Shader::setValue(const std::string &name, const Matrix* matrix) const {
    glUniformMatrix4fv(glGetUniformLocation(_program, name.c_str()), 1, GL_FALSE, matrix->data);
}
